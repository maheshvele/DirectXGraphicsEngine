...
namespace Library
{
	...
	Projector::Projector(const Game& game)
		: GameComponent(game),
	...
	Projector::Projector(const Game& game, float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance)
		: GameComponent(game),
